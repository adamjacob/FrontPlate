define(['jquery','underscore','backbone',
  'text!'+window.FrontPlateAdmin.base+'/templates/pages/edit.php'
  ...
  var PageEdit = Backbone.View.extend({
    ...
    events: {
        ...
        'click #deleteModel':'deleteThisStuff'
    ...
    render: function(){
        ...
        $.get(window.FrontPlateAdmin.base + '/api/template_values/'+this.model.get('template'), function(data){
    ...
    deleteThisStuff: function(){

        if( confirm("Delete this page?") == true ){
